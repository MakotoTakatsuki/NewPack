...
exports.formatDateToDisplay = function(d, noTime, language) {
  var day = exports.padDateField(d.getJSTDate());

  var month = exports.padDateField(d.getJSTMonth() + 1);

  var year = d.getJSTFullYear();
  ...
  var weekDay = lang(language).guiWeekDays[d.getJSTDay()];

  var hour = exports.padDateField(d.getJSTHours());

  var minute = exports.padDateField(d.getJSTMinutes());

  var second = exports.padDateField(d.getJSTSeconds());
