...
exports.iterateDates = function(date, step, limit, callback) {
  ...
  graphOps.generate(date, function generated(error) {
    ...
    if (error) {
      ...
      date.setJSTDate(date.getJSTDate() + step);
...
exports.getGraphStartDate = function(date) {
  ...
  startDate.setJSTMilliseconds(0);
  startDate.setJSTSeconds(0);
  startDate.setJSTMinutes(0);
  startDate.setJSTHours(0);
...
exports.getGraphLimitDate = function() {
  ...
  newLimit.setJSTMilliseconds(0);
  newLimit.setJSTSeconds(0);
  newLimit.setJSTMinutes(0);
  newLimit.setJSTHours(0);
  newLimit.setJSTDate(newLimit.getJSTDate() - 1);
  ...
  stats.find().sort({
    ...
    if (error) {
      ...
      for (var i = 0; i < coreCount; i++) {
        ...
        specificDate.setJSTDate(specificDate.getJSTDate() + i);
