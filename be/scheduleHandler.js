...
function torRefresh() {
  ...
  nextRefresh.setJSTSeconds(0);
  nextRefresh.setJSTMinutes(0);
  nextRefresh.setJSTHours(0);
  nextRefresh.setJSTDate(nextRefresh.getJSTDate() + 1);
...
function getStats() {
  ...
  timeToApply.setJSTMilliseconds(0);
  timeToApply.setJSTSeconds(0);
  timeToApply.setJSTMinutes(0);
  timeToApply.setJSTHours(timeToApply.getJSTHours() - 1);
...
function clearIps() {
  ...
  now.setJSTDate(now.getJSTDate() - ipExpiration);
...
function boardsStats() {
  ...
  tickTime.setJSTMilliseconds(0);
  tickTime.setJSTSeconds(5);
  tickTime.setJSTMinutes(0);
  tickTime.setJSTHours(tickTime.getJSTHours() + 1);
...
function setUniqueIpCount(results) {
  ...
  boards.bulkWrite(operations, function updatedUniqueIps(error) {
    ...
    graphDate.setJSTMilliseconds(0);
    graphDate.setJSTSeconds(0);
    graphDate.setJSTMinutes(0);
    graphDate.setJSTHours(0);
    graphDate.setJSTDate(graphDate.getJSTDate() - 1);
...
function uniqueIpCount() {
  ...
  nextRefresh.setJSTMilliseconds(0);
  nextRefresh.setJSTSeconds(0);
  nextRefresh.setJSTMinutes(0);
  nextRefresh.setJSTHours(0);
  nextRefresh.setJSTDate(nextRefresh.getJSTDate() + 1);
...
function startPruning() {
  ...
  commitAt.setJSTMilliseconds(0);
  commitAt.setJSTSeconds(0);
  commitAt.setJSTMinutes(commitAt.getJSTMinutes() + 1);
...
function autoFilePruning() {
  ...
  nextPrune.setJSTMilliseconds(0);
  nextPrune.setJSTSeconds(0);
  nextPrune.setJSTMinutes(0);
  nextPrune.setJSTHours(0);
  nextPrune.setJSTDate(nextPrune.getJSTDate() + 7 - nextPrune.getJSTDay());
...
function getInactiveAccounts() {
  ...
  var dayToSet = limitDate.getJSTDate() - settings.inactivityThreshold;

  limitDate.setJSTDate(dayToSet);
...
function inactivityTagging() {
  ...
  nextCheck.setJSTMilliseconds(0);
  nextCheck.setJSTSeconds(0);
  nextCheck.setJSTMinutes(0);
  nextCheck.setJSTHours(0);
  nextCheck.setJSTDate(nextCheck.getJSTDate() + 1);
...
function incrementalIp() {
  ...
  var hoursToUse = nextRefresh.getJSTHours() === 23 ? 2 : 1;
  nextRefresh.setJSTHours(nextRefresh.getJSTHours() + hoursToUse);
...
function cacheBuffer() {
  ...
  nextCleanUp.setJSTMilliseconds(0);
  nextCleanUp.setJSTSeconds(nextCleanUp.getJSTSeconds() + 10);
